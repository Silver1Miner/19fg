...
onready var extra_hunts = $ExtraHunt
...
func check_extra_hunt_button() -> void:
	if extra_hunts and hunt_button:
		extra_hunts.disabled = UserData.arrows < 10 or not hunt_button.disabled
